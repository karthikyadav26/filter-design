...
\author{G . Karthik Yadav\\EE23BTECH11024}
\date{}
...
\begin{lstlisting}
https://github.com/karthikyadav26/filter-design/blob/main/codes/p1.py
\end{lstlisting}
\begin{figure}[htbp]
    \centering
    \includegraphics[width=1\linewidth]{figs/p1.png}
...
\begin{lstlisting}
https://github.com/karthikyadav26/filter-design/blob/main/codes/skgen.c
\end{lstlisting}
The poles obtained are formulated in the table below.
\input{tables/table1.tex}
The below code plots the pole-zero plot.
\begin{lstlisting}
https://github.com/karthikyadav26/filter-design/blob/main/codes/p2.py
\end{lstlisting}
\newpage
\begin{figure}[htbp]
    \centering
    \includegraphics[width=1\linewidth]{figs/p2.png}
...
\end{align}
\begin{lstlisting}
https://github.com/karthikyadav26/filter-design/blob/main/codes/p3.py
\end{lstlisting}
\newpage
\begin{figure}[htbp]
    \centering
    \includegraphics[width=1\linewidth]{figs/p3.png}
...
\begin{lstlisting}
https://github.com/karthikyadav26/filter-design/blob/main/codes/p4.py
\end{lstlisting}
\begin{figure}[htbp]
    \centering
    \includegraphics[width=1\linewidth]{figs/p4.png}
...
\end{align}
 \begin{lstlisting}
https://github.com/karthikyadav26/filter-design/blob/main/codes/p5.py
\end{lstlisting}
\begin{figure}[htbp]
    \centering
    \includegraphics[width=1\linewidth]{figs/p5.png}
...
\end{align}
\begin{lstlisting}
https://github.com/karthikyadav26/filter-design/blob/main/codes/p6.py
\end{lstlisting}
\begin{figure}[htbp]
    \centering
    \includegraphics[width=1\linewidth]{figs/p6.png}
...
\end{enumerate}
\begin{lstlisting}
https://github.com/karthikyadav26/filter-design/blob/main/codes/p7.py
\end{lstlisting}
\newpage
\begin{figure}[htbp]
    \centering
    \includegraphics[width=1\linewidth]{figs/p7.png}
...
\end{align}
\begin{lstlisting}
https://github.com/karthikyadav26/filter-design/blob/main/codes/p8.py
\end{lstlisting}
\begin{figure}[htbp]
    \centering
    \includegraphics[width=1\linewidth]{figs/p8.png}
